...
class c_sound_esp {
public:
    void draw(FrameStage stage) noexcept;
    void draw_circle(color colors, Vector position) noexcept;
    void event_player_footstep(GameEvent* event) noexcept;
    void event_player_hurt(GameEvent* event) noexcept;
    void draw() noexcept;
};
